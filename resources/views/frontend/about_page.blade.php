                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img src="{{url($blog->blog_image)}}" alt=""></a>
                            ...
                            <div class="blog__post__content">
                                ...
                                <h3 class="title"><a href="{{route('details.blog',$blog->id)}}">{!! Str::limit($blog->blog_description,200) !!}</a></h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="homeContact__content">
                                ...
                                <h2 class="mail"><a href="mailto:hayaokar20@hotmail.com">hayaokar20@hotmail.com</a></h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
