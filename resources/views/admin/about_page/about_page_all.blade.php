                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="short_description" id="short_description" required="" class="form-control" rows="5">{{ $about->short_description }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="long_description" id="long_description" required="" class="form-control" rows="5">{{ $about->long_description }}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
